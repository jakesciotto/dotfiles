...
- `.gitconfig` default identity settled: personal (gmail) default on every box, work identity only via `includeIf` work-dir blocks; m4max is a personal machine and must never default to work
